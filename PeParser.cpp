...
HRESULT CPEParser::_FindResource(_In_ LPCWSTR szNameW, _In_ LPCWSTR szTypeW, _In_ WORD wLang, _Out_ LPBYTE *lplpData,
                                 _Out_ SIZE_T *lpnDataSize)
{
    ...
    *lpnDataSize = 0;
    ...
    lpTypeResDir = (PIMAGE_RESOURCE_DIRECTORY)((LPBYTE)lpResourceDir + (SIZE_T)(sDirEntry.OffsetToData & 0x7FFFFFFF));
    ...
    lpNameResDir = (PIMAGE_RESOURCE_DIRECTORY)((LPBYTE)lpResourceDir + (SIZE_T)(sDirEntry.OffsetToData & 0x7FFFFFFF));
